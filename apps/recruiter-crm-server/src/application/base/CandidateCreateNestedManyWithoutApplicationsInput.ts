...
@InputType()
class CandidateCreateNestedManyWithoutApplicationsInput {
...
export { CandidateCreateNestedManyWithoutApplicationsInput as CandidateCreateNestedManyWithoutApplicationsInput };
