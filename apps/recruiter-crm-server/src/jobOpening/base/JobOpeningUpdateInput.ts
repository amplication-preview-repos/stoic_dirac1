...
@InputType()
class JobOpeningUpdateInput {
  @ApiProperty({
    required: false,
    type: () => ApplicationUpdateManyWithoutJobOpeningsInput,
  })
  @ValidateNested()
  @Type(() => ApplicationUpdateManyWithoutJobOpeningsInput)
  @IsOptional()
  @Field(() => ApplicationUpdateManyWithoutJobOpeningsInput, {
    nullable: true,
  })
...
export { JobOpeningUpdateInput as JobOpeningUpdateInput };
